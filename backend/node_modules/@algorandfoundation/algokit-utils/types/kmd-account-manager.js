    ...
    async kmd() {
        if (this._kmd === undefined) {
            if (await this._clientManager.isLocalNet()) {
                const { kmdConfig } = types_clientManager.ClientManager.getConfigFromEnvironmentOrLocalNet();
                if (kmdConfig) {
                    this._kmd = types_clientManager.ClientManager.getKmdClient(kmdConfig);
                    return this._kmd;
                }
            }
            this._kmd = null;
